...
Software is everywhere — from phones to cars — and attackers know it. Most cyberattacks happen because of weak code, not weak firewalls.
🔹 Why it matters
...
🔹 The problem
Developers used to think security could wait until after the product shipped. But fixing security late can cost up to 200× more than fixing it during design.
...
✅ Chapter Quick-Check (Memory Joggers for OA)
	1. Fixing a flaw after release costs up to 200× more.
	2. CIA Triad → Confidentiality, Integrity, Availability.
	3. Quality ≠ Secure — both must be tested separately.
	4. Threat modeling = spotting risks early.
	5. Secure code starts during design, not deployment.
...
Mnemonic: “P-D-C-T-R-M” → Please Don’t Code The Risky Mistakes
...
Two main models dominate the industry:
	1. BSIMM (Building Security In Maturity Model) – descriptive (shows what companies actually do).
	2. SAMM (Software Assurance Maturity Model) – prescriptive (guides what you should do).
🔹 BSIMM (Observation-based)
	• Built by studying over 100 real companies.
	• Divides practices into 12 activities and 4 domains:
		○ Governance: Strategy, metrics, policy, training.
		○ Intelligence: Attack models, design, requirements.
		○ SSDL Touchpoints: Architecture review, code review, testing.
		○ Deployment: Pen testing, environment hardening, vulnerability management.
Mnemonic: “G-I-T-D = Governance, Intelligence, Touchpoints, Deployment.”
Analogy:
...
Mnemonic: “G-D-I-V-O = Good Developers Integrate Verified Operations.”
Example:
...
Example:
They define how to measure software maturity — how fast you patch, how often you test, and how secure your code is statistically.
...
Example:
SANS reports often show injection flaws as top causes of breaches year after year.
...
1️⃣ Static Analysis (SAST): Finds bugs in code without running it.
2️⃣ Dynamic Analysis (DAST): Finds flaws while the app runs.
3️⃣ Fuzzing: Sends random inputs to see if it breaks.
...
Example:
A developer shouldn’t have access to production credit card data.
Analogy:
...
Example:
Encrypt personal info and anonymize data before sharing with analytics systems.
Analogy:
...
Mnemonic: “EARLY = Examine Assets, Regulations, Liabilities Year-one.”
...
Analogy: You’re the architect and fire marshal of the same building — you must design for both function and safety.
Real Tip: Looping in security early reduces later re-work and saves time + costs.
...
Analogy: PIA is like a seatbelt for user privacy — you install it before driving, not after a crash.
...
Mnemonic: “DISCOVER = Define Initial Security Controls On Very Early Requirements.”
...
Analogy: This meeting is like a “pre-flight checklist” before take-off — you don’t want to find a fuel leak mid-air.
...
Analogy: This plan is your project’s security GPS — it keeps everyone on course.
...
Analogy: Think of PIA as a “lock audit” — you’re checking every door and window in your data house to ensure no stranger has keys.
...
Analogy: These deliverables are like “blueprints, permits, and inspection reports” for a safe building.
...
Analogy: Metrics are your project’s vital signs — they tell you if the software is healthy or at risk.
...
Analogy: Phase A1 is like the “foundation pouring” of a building — everything else depends on how strongly you set it now.
...
1️⃣ Why have a Discovery Meeting? → To identify team, resources, and security requirements early.
2️⃣ PIA identifies? → Data laws, sensitivity, controls, and storage rules (All of the above).
3️⃣ Threat profile feeds into? → Threat modeling and risk analysis.
...
🧭 Chapter Overview
This is the second phase of the Security Development Lifecycle (SDL):
Architecture (A2).
...
🔹 Analogy
	Imagine a house inspection — you don’t just check the walls; you focus on gas lines, wiring, and doors where risks are highest.
Pro Tip:
...
Analogy:
	Threat modeling is like a chess match — you don’t wait for your opponent to move; you predict their moves five steps ahead.
...
Core secure design goals:
	...
	2. Defense in Depth – Layer your defenses.
	3. Fail Securely – Even when errors happen, no info should leak.
	4. Economy of Mechanism – Keep design simple = fewer holes.
	5. Separation of Duties – No single person or process controls everything.
Analogy:
...
The SRR checks:
	1. All SDL activities (A1–A3) are done.
	2. Security flaws found in testing are resolved or accepted.
	3. Privacy Impact Assessment (PIA) is finalized.
	4. Threat models and risk mitigations are documented.
	5. Release notes reflect known security constraints.
Analogy:
...
Why it matters:
Attackers don’t stop after release — monitoring ensures issues are detected before they become breaches.
Key Actions:
...
Concept:
Agile emphasizes speed, collaboration, and continuous improvement through short sprints.
How to apply SDL:
...
Concept:
DevOps unites development and operations for faster, automated delivery.
...
Concept:
Cloud applications are dynamic and elastic — security must focus on configurations, APIs, and access control.
SDL adjustments:
...
Concept:
A digital enterprise integrates SDL into every business process — from supply chain to customer portals.
SDL focus:
...
A3/A4 – Development & Implementation	Secure coding & testing	# of vulnerabilities per 1K lines of code
A5 – Verification & Validation	Pen testing results	% of high findings remediated
...
Purpose:
Helps measure and improve your organization’s security maturity level.
Five Core Functions:
...
Purpose:
Describes how real organizations perform software security activities — a descriptive model.
...
Goal:
Integrate all SDL activities — assessment, design, development, validation, and sustainment — into one continuous cycle.
Analogy:
...
Purpose:
Ensure each SDL phase has:
	• Clear deliverables.
	• Traceable metrics.
	• Continuous improvement process.
Example:
Post-release metrics track Mean Time to Patch (MTTP) and Incident Frequency (IF) — used to evaluate SDL effectiveness.
...
🔹 Postmortem Actions
	1. Shut down the compromised systems temporarily.
	2. Removed malicious code and resecured SQL databases.
	3. Trained new development teams on security best practices.
	4. Implemented a Security Development Lifecycle (SDL) to prevent recurrence.
...
Mnemonic:
	“R-E-V-V-I-N” = Revvin’ Lessons:
		...
		○ Enforce SDL early
		○ Validate inputs
		○ Verify code and configs
		○ Involve experts
		○ Never ignore post-deployment monitoring
Analogy:
...
Mnemonic:
	“R-CIA” = Reliability first, then CIA.
...
Mnemonic:
	“DPLB = Design, Prevent, Least, BSIMM.”
...
Mnemonic:
	“EEL = Economy, Encryption, Least mechanism.”
...
Mnemonic:
	“V-SAFE = Validate, Secure, Avoid leaks, Fix early.”
...
Mnemonic:
	“R-D-M = Resolve, Drill, Mix (diverse teams).”
...
Everything is short, memory-friendly, and verified.
...
PRSA (Post-release): Continuous monitoring<img width="547" height="31566" alt="image" src="https://github.com/user-attachments/assets/99d79f82-f41e-41ff-99e6-6984e0323197" />
